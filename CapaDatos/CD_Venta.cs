...
namespace CapaDatos
{
    public class CD_Venta
    {
                            ...
                            if (doc.Element("DETALLE_VENTA") != null)
                            {
                                rptDetalleVenta = (from dato in doc.Elements("DETALLE_VENTA")
                                                   select new Venta()
                                                   {
                                                       ...
                                                       Descuento = float.Parse(dato.Element("DescuentoImporte").Value, NuevaCultura),
        ...
        public List<Venta> ObtenerListaVenta(string Codigo, string FechaInicio, string FechaFin, string NumeroDocumento, string Nombre)
        {
