    ...
    public class VentaController : Controller
    {
        ...
        public ActionResult Documento(int IdVenta = 0)
        {
            ...
            if (oVenta == null)
                ...
                oVenta.TextoSubTotal = oVenta.SubTotal.ToString("N", formato);
            }
        ...
        public JsonResult Obtener(string codigo, string fechainicio, string fechafin, string numerodocumento, string nombres)
        {
            ...
            List<Venta> lista = CD_Venta.Instancia.ObtenerListaVenta(codigo, fechainicio, fechafin, numerodocumento, nombres);
            if (lista == null)
