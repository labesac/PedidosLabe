...
namespace VentasWeb.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public JsonResult ObtenerUsuarioKey()
        {
            Usuario oUsuario = (Usuario)Session["Usuario"];
            int Id_Usuario = oUsuario.IdUsuario;

            List<Usuario> oListaUsuario = CD_Usuario.Instancia.ObtenerUsuarioskey(Id_Usuario);
            return Json(new { data = oListaUsuario }, JsonRequestBehavior.AllowGet);
        }
        ...
        [HttpPost]
        public JsonResult GuardarClave(Usuario objeto)
        {
            bool respuesta = false;
